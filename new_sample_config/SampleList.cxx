...
#ifdef Atmospheric_ENABLED
    // Atmospheric sample 
#include "Atmospheric_CCMu_Ar_XSec_1DEnu_nu.h"
#endif
...
MeasurementBase *CreateSample(nuiskey samplekey) {
  ...
  std::string fkdt = "";
	...
	*/
#ifdef Atmospheric_ENABLED
   if (!name.compare("Atmospheric_CCMu_Ar_XSec_1DEnu_nu")) {
        return (new Atmospheric_CCMu_Ar_XSec_1DEnu_nu(file, rw, type, fkdt));
   }
#endif
